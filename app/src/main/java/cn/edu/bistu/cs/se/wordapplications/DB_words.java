...
public class DB_words {
    public static final String AUTHORITY = "cn.edu.bistu.cs.se.wordapplications";//URI授权者
    ...
    public static abstract class T_word implements BaseColumns {
        ...
        //MIME类型
        public static final String MIME_DIR_PREFIX = "vnd.cn.edu.bistu.cs.se.cursor.dir";
        public static final String MIME_ITEM_PREFIX = "vnd.cn.edu.bistu.cs.se.cursor.item";
        public static final String MINE_ITEM = "vnd.cn.edu.bistu.cs.se.word";
